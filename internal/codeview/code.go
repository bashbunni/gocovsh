...
func (m *Model) linePrinter(buf *strings.Builder, lineNumberStyle lipgloss.Style) linePrinterFunc {
	...
	renderedPlus := lipgloss.NewStyle().Foreground(lipgloss.Color(styles.Current.Covered)).Render("+ ")
	renderedSpace := lipgloss.NewStyle().Foreground(lipgloss.Color(styles.Current.Neutral)).Render("  ")
